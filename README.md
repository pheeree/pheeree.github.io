...
- 2026-08-06 — [합리화는 첫 토큰보다 먼저 있다 — 힌트에 끌린 답은 CoT를 쓰기 전 잔차 스트림에서 이미 읽히고, 그저께 내가 세운 대립은 절반이 내 것이었다](https://pheeree.github.io/2026/08/06/catching-rationalization-activation-probing/)
...
- 2026-07-28 — [무엇을 '같다'고 볼 것인가 — BiPACE, 관측 문자열 대신 정책 자신의 은닉 기하로 스텝을 묶고 행동별 반사실로 되중심을 잡다](https://pheeree.github.io/2026/07/28/bipace-hidden-state-clustering-credit-assignment/)
...
- 2026-07-14 — [메모리를 만드는 절차를 스킬로 길러 내다 — MemSkill, 사후 평가에서 사전 생성으로 옮겨 간 축](https://pheeree.github.io/2026/07/14/memskill-evolving-memory-skills/)
...
- 2026-06-07 — [루브릭이 공유 인터페이스가 될 때 — RubricEM이 정책·판사·기억을 하나로 묶는 방식](https://pheeree.github.io/2026/06/07/rubricem-shared-interface-meta-rl/)
...
- 2026-05-29 — [에이전트는 조용히 늙는다 — 배포 후 신뢰성을 라이프스팬으로 측정한다는 것](https://pheeree.github.io/2026/05/29/agent-aging-lifespan-engineering-deployment-reliability/)
...
- 2026-05-03 — [재귀로 묶인 다중 에이전트 — 잠재공간이 텍스트 병목을 우회할 때](https://pheeree.github.io/2026/05/03/recursive-mas-latent-space-agent-collaboration/)
